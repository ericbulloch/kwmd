...
I have included a write up for the [text encoding](concepts/encryption.md#text-encoding) in my Encryption concepts section. It covers the some of the more common scenarios that I have found during capture the flag events.
...
I have included a write up for [Linux privilege escalation](concepts/privilege_escalation.md#linux-privilege-escalation) in my Privilege Escalation concepts section. It covers the more common commands and ideas that I have found and used during capture the flag events.
