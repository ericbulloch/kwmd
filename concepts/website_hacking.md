...
For an even more detailed explaination and more examples, I talk a lot about [SQL injection](/concepts/injection.md#sql-injection) on my [injection concepts](/concepts/injection.md) page.
