...
The sqlmap tool if really effective at testing forms to see if one of the parameters is vulnerable to sql injection. A typical use case for sqlmap is to find a form, capture a request for it and then hand that request to sqlmap. 
